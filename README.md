...
| **Toy data check**             | Tiny CSV + hand-calculated lift compared to code                                                                                 |  car_brands_lift.xlsx             |   Maru      |  8 Sep    |              |  From Zan: I kind of did this, but I'm not sure I did it right... So TBD on whether all of my code is flawed...          |
| **Task A: Zipf test**          | OLS regression on log–log; slope test; plot top-100 words vs theory                                                              |  zipf_zm.ipynb             | Zan        | 4 Sep     |              |  From Maru: Added plot vs Top 100 Words          |
...
| **Task E: Insights (C & D)**   | Business insights from lift + MDS                                                                                                | vectorizer_lift_MDS_zm.ipynb              | Kristen        | 8 Sep     |              |            |
...
| **Task H: Aspirational brand** | Identify most aspirational brand + business implications                                                                         |  vectorizer_lift_MDS_zm.ipynb             | Kristen & Nikhil        | 8 Sep     |              |            |
